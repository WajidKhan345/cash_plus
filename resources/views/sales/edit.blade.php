    ...
    <section class="container my-2 w-100 bg-info text-black p-2">
        ...
        <form class="row g-3 p-2" method="post" action="{{route('sales.store')}}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="drang_commission" id="inputDrang" value="{{$sale->drang_commission}}">
            </div>
            <div class="col-md-6">
                <label for="inputWeight" class="form-label">Weight</label>
                <input type="text" class="form-control" name="weight" id="inputWeight" value="{{$sale->weight}}">
            </div>
            <div class="col-6">
                <label for="inputRate" class="form-label">Rate</label>
                <input type="text" class="form-control" name="rate" id="inputRate" value="{{$sale->rate}}">
            </div>
            <div class="col-md-6">
                <label for="inputTotalamout" class="form-label">Total Amount</label>
                <input type="text" class="form-control" name="total_amount" id="inputTotalamount" value="{{$sale->total_amount}}">
            </div>
            <div class="col-md-6">
                <label for="inputDriverprize" class="form-label">Driver Prize</label>
                <input type="text" class="form-control" name="driver_prize" id="inputDriverprize" value="{{$sale->driver_prize}}">
            </div>
            <div class="col-md-6">
                <label for="inputMineral" class="form-label">Mineral</label>
                <input type="text" class="form-control" name="mineral" id="inputMineral" value="{{$sale->mineral}}">
            </div>
            <div class="col-md-6">
                <label for="inputGovtax" class="form-label">Gov. Tax</label>
                <input type="text" class="form-control" name="gov_tax" id="inputGovtax" value="{{$sale->gov_tax}}">
            </div>
            <div class="col-md-6">
                <label for="inputAgentamount" class="form-label">Agent Amount</label>
                <input type="text" class="form-control" name="agent_amount" id="inputAgentamount" value="{{$sale->agent_amount}}">
            </div>
            <div class="col-md-6">
                <label for="inputSafiamount" class="form-label">Safi Amount</label>
                <input type="text" class="form-control" name="safi_amount" id="inputSafiamount" value="{{$sale->safi_amount}}">
            </div>
            <div class="col-md-6">
                <label for="inputReceivedamount" class="form-label">Recieved Amount</label>
                <input type="text" class="form-control" name="recieved_amount" id="inputReceivedamount" value="{{$sale->recieved_amount}}">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="discount" id="inputDiscount" value="{{$sale->discount}}">
            </div>
            <div class="col-md-6">
                <label for="inputExtra" class="form-label">Extra Amount</label>
                <input type="text" class="form-control" name="extra_amount" id="inputExtra" value="{{$sale->extra_amount}}">
            </div>
            <div class="col-md-12">
